...
class Products with ChangeNotifier {
  ...
  String? urlMaster = "https://auth-flutter01-default-rtdb.firebaseio.com/";
  List<Product> _allProduct = [];

  List<Product> get allProduct => _allProduct;

  Future<void> addProduct(String title, String id) async {
  ...
  void deleteProduct(String id, Type string) async { 
    Uri url = Uri.parse("$urlMaster/products/$id.json?auth=$token");
